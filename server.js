...
app.listen(PORT, () => {
    ...
    console.log(`   - JWT密钥: ${process.env.JWT_SECRET ? '已配置' : '⚠️  使用默认值'}`);
    console.log(`   - CORS: ${allowedOrigins.join(', ')}`);
    console.log(`   - LLM: ${process.env.LLM_API_KEY ? '已配置' : '未配置（可选）'}`);
    console.log(`\n📚 可用接口:`);
    console.log(`   公开接口：`);
